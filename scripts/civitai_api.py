...
def contenttype_folder(content_type, desc=None, fromCheck=False):
    ...
    if content_type == "Checkpoint":
        if cmd_opts.ckpt_dir:
            ...
            folder = os.path.join(models_path,"Neko-model")
        ...
        folder = os.path.join(extensions_dir, "startfk-aesthetic-gradients", "aesthetic_embeddings")
        ...
        folder = os.path.join(extensions_dir, "startfk-animatediff", "model")
